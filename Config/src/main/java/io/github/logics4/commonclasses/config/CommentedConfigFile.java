...
import io.github.logics4.commonclasses.config.formats.CommentedConfigType;
import io.github.logics4.commonclasses.config.formats.HOCON;
...
public class CommentedConfigFile {

    private CommentedConfigType configFile;
    private CommentedConfigurationNode config;
    private Path dataFolderPath;
    private String configFileName;
    private Path configFilePath;

    public CommentedConfigFile(ConfigFileFormat format, Path dataFolderPath, String configFileName) {
        ...
        switch (format) {
            case HOCON: {
                configFile = new HOCON(dataFolderPath, configFileName);
                break;
            }
            default: {
    ...
    public CommentedConfigFile loadConfig() {
        try {
